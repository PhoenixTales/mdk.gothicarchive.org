...
* For readability as well as to reduce strains on the eyes and in order to fit better to the overall gothic style and the rest of our websites, we re-interpreted the original html documentation in a dark-mode. Therefore: The white background turns black, light grey backgrounds into dark grey, and light blue backgrounds into dark blue; text and link colours are adjusted accordingly. 
